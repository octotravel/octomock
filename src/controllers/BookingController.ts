...
interface IBookingController {
  ...
  confirmBooking(schema: ConfirmBookingSchema): Promise<Booking>;
  confirmBooking(schema: UpdateBookingSchema): Promise<Booking>;
  extendBooking(schema: ExtendBookingSchema): Promise<Booking>;
  cancelBooking(schema: CancelBookingSchema): Promise<Booking>;
  getBooking(schema: GetBookingSchema): Promise<Booking>;
  getBookings(schema: GetBookingsSchema): Promise<Booking[]>;
}
...
export class BookingController implements IBookingController {
  ...
  public getBooking = async (schema: GetBookingSchema): Promise<Booking> => {
