...
export class BookingPricingModel {
  ...
  constructor(product: ProductModel, option: OptionModel, unitItems: UnitItem[]) {
  ...
  public getPricing = (): Pricing => {
    const isPricingPerBooking = this.product.productPricingModel.pricingPer === PricingPer.BOOKING
